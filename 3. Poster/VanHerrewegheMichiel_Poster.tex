...
\title{Een onderzoek naar de maturiteit van .NET MAUI bij het vervangen van een real-time POS-systeem}
\author{Michiel Van Herreweghe}
\email{michiel.vanherreweghe@outlook.com}
\supervisor{Martine Van Audenrode}
\cosupervisor{Kristof Van Moorter (Vandapower)}

% Indien ingevuld, wordt deze informatie toegevoegd aan het einde van de
% abstract. Zet in commentaar als je dit niet wilt.
\specialisation{Mobile \& Enterprise Web Development}
